...
from ansible_collections.piolink.ansible_collection_webfrontk.plugins.module_utils.prest_module import PrestModule, \
...
class PrestUtils(PrestModule):
    def __init__(self, module):
        super(PrestUtils, self).__init__(module)
